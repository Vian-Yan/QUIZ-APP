  ...
  return (
    <>
      <div className="h-full relative w-full flex-col flex gap-10 sm:gap-30 items-center sm:p-10 border border-red-50 p-6 font-alfa-slab-one text-3xl ">
        <div className="text-white text-3xl text-center bg-copper p-2 rounded-lg animate-fade-in-up delay-300 transition-transform duration-200">
          {`Jawaban Benar: ${score.correct} / ${score.total}`}
        </div>
        <div className="flex flex-col justify-center items-center gap-4 ">
          <div className="text-3xl lg:text-6xl">Your Score</div>
          <div className=" rounded- text-center border w-45 h-45 rounded- text-pastelPink flex flex-col justify-evenly items-center rounded-[50%] animate-fade-in-up delay-300 transition-transform duration-200 lg:h-60 lg:w-60 lg:text-8xl text-6xl ">
      ...
      <div
        ...
        className="absolute  bottom-13 md:bottom-28 sm:bottom-26 right-0 flex justify-end w-full gap-4 p-4 items-center text-sm sm:text-3xl lg:bottom-4 "
      >
